...
{
	cout <<  __func__ << "(), read " << bytes_transferred << " bytes" << endl;
	...
	int read_size)
{
	...
	cout << "before ioservice.run()" << endl;
	ios.run();
	cout << "after ioservice.run()" << endl;
...
{
	cout <<  __func__ << "(), write " << bytes_transferred << " bytes" << endl;
