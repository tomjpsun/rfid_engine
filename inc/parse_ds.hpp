...
//#define CMD_RFID_READ_TAG					'R'		// Read tag memory data
#define CMD_RFID_READ_EPC					'Q'		// Display tag EPC ID
#define CMD_RFID_READ_TID					'R'
//#define CMD_RFID_WRITE_TAG					'W'		// Write data to tag memory
...
}RFID_BANK_TYPE, *PRFID_BANK_TYPE;
...
}RFID_LOCK_TYPE, *PRFID_LOCK_TYPE;
...
}RFID_REGULATION, *PRFID_REGULATION;
...
}RFID_MEMORY_BANK, *PRFID_MEMORY_BANK;
