...
#define RFID_ERR_INVALID_BUFFER           (RFID_LIB_SCOPE | 0x10 )
#define RFID_ERR_FILE_NOT_EXIST           (RFID_LIB_SCOPE | 0x11 )
#define RFID_ERR_CMD_DEVICE_NOT_SUPPORT   (RFID_LIB_SCOPE | 0x12 )
