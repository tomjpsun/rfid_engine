...
#define RF_PT_REQ_SET_DATE_TIME						0x00000019	// Set Date (@SETDATE%04d%02d%02d%02d%02d%02d)


#define RF_PT_REQ_GET_TAG_EPC_ID					0x00000003	// Q : display tag EPC ID
...
//#define RF_PT_REQ_GET_MULTI_TAG_EPC_ID			0x00000009	// U : Multi - TAG read EPC
...
//#define RF_PT_REQ_GET_SIGNLE_TAG_EPC				0x00000003	// Q : Read single tag EPC
...
#define RF_PT_REQ_INVENTORY_TAG_EPC_ONCE			0x00000009	// U : Read multiple tag EPC / Multi - TAG read EPC
#define RF_PT_REQ_INVENTORY_TAG_EPC_LOOP			0x00000025	// @U : Read multiple tag EPC / Multi - TAG read EPC

//#define RF_PT_REQ_GET_MULTI_TAG_EPC					0x00000025	// @U : Read single tag EPC / Multi - TAG read EPC
//#define RF_PT_REQ_INVENTORY_TAG				RF_PT_REQ_SELSECT_MATCHING_TAG	// T : Select matching tag // Inventory

//#define RF_PT_REQ_GET_MULTI_TAG_EPC_TID_ONCE		0x00000027	// U[X],R : Read multiple tag EPC and TID
//#define RF_PT_REQ_GET_MULTI_TAG_EPC_TID_LOOP		0x00000028	// @U[X] : Read multiple tag EPC and TID
...
#define RF_PT_RES_GET_MULTI_TAG_EPC					0x00000089	// U : Read single tag EPC / Multi - TAG read EPC
